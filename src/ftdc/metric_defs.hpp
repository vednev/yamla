...
inline const std::unordered_map<std::string, MetricDef>& metric_defs() {
    static const std::unordered_map<std::string, MetricDef> table = {
        ...
        {"serverStatus.connections.current",
            {"Conns Current", "count", false, 5000.0}},
        {"serverStatus.connections.available",
            {"Conns Available", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.connections.totalCreated",
            {"Conns Created", "conns/s", true, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.connections.active",
            {"Conns Active", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.concurrentTransactions.read.available",
            {"WT Read Tickets Avail", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.wiredTiger.concurrentTransactions.write.available",
            {"WT Write Tickets Avail", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.log.yields waiting for previous log file close",
            {"WT Log Yield Close", "ops/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.log.written slots coalesced",
            {"WT Log Coalesced", "ops/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.log.log bytes of payload data",
            {"WT Log Payload", "bytes/s", true, std::numeric_limits<double>::quiet_NaN()}},

        // ---- WT checkpoint ----
        {"serverStatus.wiredTiger.checkpoint.most recent time (msecs)",
            {"Ckpt Duration", "ms", false, 60000.0}},
        {"serverStatus.wiredTiger.checkpoint.max time (msecs)",
            {"Ckpt Max Time", "ms", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.wiredTiger.checkpoint.generation",
            {"Ckpt Generation", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.wiredTiger.checkpoint.total time (msecs)",
            {"Ckpt Total Time", "ms", true, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.wiredTiger.checkpoint.prepare currently running",
            {"Ckpt Prepare Running", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.wiredTiger.checkpoint.currently running",
            {"Ckpt Running", "count", false, std::numeric_limits<double>::quiet_NaN()}},

        // ---- WT lock ----
        {"serverStatus.wiredTiger.lock.schema lock application thread wait time (usecs)",
            {"WT Schema Lock", "us/s", true, 1000000.0}},

        // ---- WT data-handle ----
        {"serverStatus.wiredTiger.data-handle.connection data handles currently active",
            {"WT Data Handles", "count", false, 10000.0}},
        {"serverStatus.wiredTiger.data-handle.connection sweep dhandles closed",
            {"WT Sweep Closed", "count/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.cursor.cursor operation restarted",
            {"WT Cursor Restart", "ops/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.transaction.oldest pinned transaction ID rolled back for eviction",
            {"WT Oldest Pinned Rollback", "count/s", true, 100.0}},
        {"serverStatus.wiredTiger.transaction.transaction range of timestamps currently pinned",
            {"WT TS Range Pinned", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.wiredTiger.thread-yield.application thread time waiting for cache (usecs)",
            {"WT App Cache Wait", "us/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.tcmalloc.tcmalloc.pageheap_free_bytes",
            {"tcmalloc Pageheap", "bytes", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.tcmalloc.tcmalloc.central_cache_free_bytes",
            {"tcmalloc Central Free", "bytes", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.tcmalloc.tcmalloc.transfer_cache_free_bytes",
            {"tcmalloc Transfer Free", "bytes", false, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.tcmalloc.tcmalloc.thread_cache_free_bytes",
            {"tcmalloc Thread Free", "bytes", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.storageEngine.dropPendingIdents",
            {"Pending Drops", "count", false, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.metrics.repl.apply.batches.totalMillis",
            {"Repl Apply Batch", "ms/s", true, std::numeric_limits<double>::quiet_NaN()}},
        ...
        {"serverStatus.metrics.repl.network.getmores.totalMillis",
            {"Repl Getmore Dur", "ms/s", true, std::numeric_limits<double>::quiet_NaN()}},
        {"serverStatus.metrics.repl.network.bytes",
            {"Repl Net Bytes", "bytes/s", true, std::numeric_limits<double>::quiet_NaN()}},
